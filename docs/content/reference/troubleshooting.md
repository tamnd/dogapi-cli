...
Most of these come down to network reality or how dogapi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

dogapi rate-limits like any public site. dogapi already paces
...
Where a surface is gated, dogapi reads a cookie or token you supply
...
`dogapi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what dogapi actually did
