...
```
dogapi <command> [arguments] [flags]
```

Run `dogapi <command> --help` for the full flag list on any command. This
...
a row here per operation you declare in `dogapi/domain.go`.
